...
const Leaves = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/admin/get_leaves")
      .then((result) => {
  ...
  function handleAccept(leaveId){
    axios.put("http://localhost:5000/admin/accept_leave",{leaveId});
  }

  function handleReject(leaveId){
    axios.put("http://localhost:5000/admin/reject_leave",{leaveId});
  }
