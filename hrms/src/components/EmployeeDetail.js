...
const EmployeeDetail = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:5000/emp/details/'+id)
        .then(result => {
        ...
        axios
        .get("http://localhost:5000/emp/get_my_leave/" + id)
        .then((result) => {
    ...
    const handleLogout = () => {
        axios.get('http://localhost:5000/emp/logout')
        .then(result => {
                      ...
                      return (
                        <tr>
                          ...
                          <td><button onClick={()=>{
                            ...
                            axios.delete('http://localhost:5000/emp/delete_leave',{data})
